...
class User(UserMixin, db.Model):
    ...
    user_id = db.Column(db.String(12), unique=True, nullable=False, default=_gen_user_id)
    ...
    referral_code = db.Column(db.String(12), unique=True, nullable=False, default=_gen_referral)
    referred_by = db.Column(db.String(12), nullable=True)
    last_ip = db.Column(db.String(45), nullable=True)
    last_user_agent = db.Column(db.String(512), nullable=True)
    avatar_seed = db.Column(db.String(36), nullable=False, default=lambda: str(uuid.uuid4()))
