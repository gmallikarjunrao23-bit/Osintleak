"""Application configuration — all values from Railway environment variables."""
import os
from datetime import timedelta


class Config:
    """Base configuration — reads directly from environment, no .env needed."""
    ...
    # Cache — Railway Redis plugin sets REDIS_URL automatically
